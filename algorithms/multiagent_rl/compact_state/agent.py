...
The agent is state-representation-agnostic: it stores Q-values keyed by
whatever tuple _state() returns, so it works with both the original frozenset
state and the compact nearest-coin-delta state.
"""
